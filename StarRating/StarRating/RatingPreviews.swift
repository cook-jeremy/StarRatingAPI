...
//    var color: Color
//    func makeBody<V: BinaryFloatingPoint>(configuration: RatingStyleConfiguration<V>, index: Int) -> any View {
...
//        let isFilled = V(index) < configuration.value
...
//    VStack(spacing: 10) {
//        Rating(value: .constant(3))
//            .ratingStyle(SystemImageRatingStyle(systemName: "trophy"))
//            .foregroundColor(.yellow)
//        
//        Rating(value: .constant(3))
//            .ratingStyle(SystemImageRatingStyle(systemName: "volleyball"))
//            .foregroundStyle(.green)
//        
//        Rating(value: .constant(3))
//            .ratingStyle(SystemImageRatingStyle(systemName: "wineglass"))
//            .foregroundStyle(.red)
//        
//        Rating(value: .constant(3))
//            .ratingStyle(SystemImageRatingStyle(systemName: "basketball"))
...
//    func makeStar<V: BinaryFloatingPoint>(configuration: RatingStyleConfiguration<V>, index: Int) -> any View {
//        let percent: V = configuration.value - V(index)
