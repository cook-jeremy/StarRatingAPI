...
class StarRatingTests: XCTestCase {
    ...
    func testTapLocation() throws {
        ...
        XCTAssertEqual(tapLocation.value(precision: 0), 0)
        ...
        XCTAssertEqual(tapLocation.value(precision: 0.5), 1.0)
        XCTAssertEqual(tapLocation.value(precision: 0.25), 0.75)
        
        tapLocation = rating.location(5, starWidth: 20, spacingWidth: 10)
        XCTAssertEqual(tapLocation, .star(index: 0, remainder: 0.25))
        XCTAssertEqual(tapLocation.value(precision: 0.5), 0.5)
        XCTAssertEqual(tapLocation.value(precision: 0.25), 0.5)
        
        tapLocation = rating.location(15, starWidth: 20, spacingWidth: 10)
        XCTAssertEqual(tapLocation, .star(index: 0, remainder: 0.75))
        XCTAssertEqual(tapLocation.value(precision: 0.5), 1)
        XCTAssertEqual(tapLocation.value(precision: 0.25), 1)
        
        tapLocation = rating.location(200, starWidth: 20, spacingWidth: 10)
        XCTAssertEqual(tapLocation, .star(index: 4, remainder: 1))
        XCTAssertEqual(tapLocation.value(precision: 0.5), 5)
        XCTAssertEqual(tapLocation.value(precision: 0.25), 5)
